...
class ProjectForm(ClusterBaseModelForm):
    ...
    class Meta:
        model = Project
        exclude = ('single_member', 'cluster', 'project_status', 'score', 'supervisor','allow_edit','show_in_intro','intro_file')
...
class ProjectManagerForm(ProjectForm):
    class Meta:
        model = Project
        exclude = ('single_member', 'cluster', 'score', 'supervisor','allow_edit','show_in_intro','intro_file')
