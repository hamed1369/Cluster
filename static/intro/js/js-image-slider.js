...
function mcImgSlider(l) {
    ...
    var b = "style", y = "display", F = "visibility", j = "width", z = "height", X = "top", P = "background", r = "undefined", w = "marginLeft", v = "appendChild", q = "parentNode", o = "nodeName", Q = "innerHTML", W = "offsetWidth", C = setTimeout, K = clearTimeout, E = "indexOf", N = "setAttribute", jb = "removeChild", D = function () {
        ...
        if ((c = a[E]("MSIE ")) != -1)b = parseInt(a.substring(c + 5, a[E](".", c)));
        if (a[E]("Safari") != -1 && a[E]("Chrome") == -1)b = 300;
        if (a[E]("Opera") != -1)b = 400;
        return b
    }, bb = hb() < 9, M = function (a, c) {
        if (a) {
            a.o = c;
            if (bb)a[b].filter = "alpha(opacity=" + c * 100 + ")"; else a[b][i] = c
        }
    };
    D.a = {f: function (a) {
    ...
    D.prototype = {k: {c: l.transitionTime, a: function () {
    }, b: D.a.f, d: 1}, m: function (h, d, g, c) {
        ...
        if (a) {
            ...
            if (T && db)db(this.b); else window.clearInterval(this.b);
            this.b = null
        }
    }, o: function (a) {
        if (a.d.e < a.d[e]) {
    ...
    var k = new D, ob = function () {
        ...
        return a.join("")
    }, c = {a: 0, e: "", d: 0, c: 0, b: 0}, a, g, u, B, U, O, V, n, p, Z, J, t, G, I, s, ib, S, R, eb, d, L, m = null, Ab = function () {
        ...
        a = {b: l.pauseTime, c: l.transitionTime, f: l.slices, g: l.boxes, d: l.license, h: l.hoverPause, i: l.autoAdvance, j: l.captionOpacity, k: l.captionEffect == "none" ? 0 : l.captionEffect == "fade" ? 1 : 2, l: l.thumbnailsWrapperId, Ob: function () {
            typeof beforeSlideChange !== r && beforeSlideChange(arguments)
        }, Oa: function () {
            typeof afterSlideChange !== r && afterSlideChange(arguments)
        }};
        if (g)a.m = Math.ceil(g.offsetHeight * a.g / g[W]);
        qb(l.effect);
        a.n = function () {
            var b;
            if (a.a.p == -1)b = a.a[Math.floor(Math.random() * a.a[e])]; else {
                b = a.a[a.a.p];
                a.a.p++;
                if (a.a.p >= a.a[e])a.a.p = 0
            }
            if (b < 1 || b > 17)b = 15;
            return b
        }
        ...
        if (c.b != 2) {
            c.b = 0;
            if (s == null && !c.c && a.i)s = C(function () {
                m.y(m.n(c.a + 1), 0, 1)
            }, a.b / 2)
        }
    }, yb = function () {
        var a = 0, b = 0, c;
        while (a < d.length) {
            c = d[a][f] == "lazyImage" || d[a][h]("data-src") || d[a][f][E](" video") > -1 && typeof McVideo != r;
            if (c) {
                b = 1;
                break
            }
        ...
        var a = x[e];
        if (a)while (a--)x[a][f] = a != b && x[a].on == 0 ? "thumb" : "thumb thumb-on"
    }, zb = function (a) {
        ...
        var g;
        if (a.l)g = Y(a.l);
        if (g)for (var h = lb(g, "*"), d = 0; d < h[e]; d++)h[d][f] == "thumb" && x.push(h[d]);
        var b = x[e];
        if (b) {
            while (b--) {
                x[b].on = 0;
        ...
        for (var b = [], a = 0; a < d[e]; a++)b[b[e]] = String.fromCharCode(d.charCodeAt(a) - (c ? c : 3));
        return b.join("")
    ...
    tb.prototype = {c: function () {
        ...
        while (n--) {
            i = l[n];
            j = 0;
            if (i[o] == "BR" || bb && r.test(i[o]))g[jb](i); else {
                i[b][y] = "none";
                ...
                if (i[o] == "A" && i[f][E]("lazyImage") == -1)if (i[f])i[f] = "imgLink " + i[f]; else i[f] = "imgLink";
                if (j)d.push(j); else d.push(i);
                if (i[f][E](" video") != -1) {
                    this.A(i);
                    this.b(i)
                }
        ...
        this.i();
        var m = this.v();
        if (d[c.a][o] == "IMG")c.e = d[c.a]; else c.e = lb(d[c.a], "img")[0];
        if (d[c.a][o] == "A" || d[c.a][f] == "video")d[c.a][b][y] = "block";
        g[b][P] = 'url("' + c.e[h]("src") + '")';
        U = this.k();
        var k = c.e[q], p;
        if (p = k.aP) {
        ...
        var e = H(S), a = c.d;
        while (a--) {
            if (a == c.a)e[a][f] = "active"; else e[a][f] = "";
            if (d[a][o] == "A" || d[a][f] == "video")d[a][b][y] = a == c.a ? "block" : "none"
        }
    }, i: function () {
        O = A("mc-caption");
        V = A("mc-caption");
        ...
        if (a.k == 2) {
            J = G = {opacity: 0, width: 0, marginLeft: Math.round(Z[2] / 2)};
            t = {opacity: 1, width: Z[2], marginLeft: 0};
            I = {opacity: a.j, width: Z[2], marginLeft: 0}
        } else if (a.k == 1) {
            J = G = {opacity: 0};
            t = {opacity: 1};
            I = {opacity: a.j}
        ...
        var d = 1;
        if (O[Q][e] > 1)if (!a.k)n[b][F] = p[b][F] = "hidden"; else {
            d = 0;
            var c = {c: a.c * .3, b: a.k == 1 ? D.a.f : D.a.h, d: a.k == 1 ? 0 : 2}, f = c;
            f.a = function () {
                n[b][F] = p[b][F] = "hidden";
                m.m()
            };
        ...
        if (U) {
            ...
            if (a.k) {
                var d = a.c * a.k;
                if (d > 1e3)d = 1e3;
                var c = {c: d, b: a.k == 1 ? D.a.g : D.a.j, d: a.k == 1 ? 0 : 2};
                if (typeof t[w] !== r) {
        ...
        var a = d[j], k = 0;
        if (a[o] == "A" && a[f][E]("lazyImage") == -1 || a[o] == "DIV" && a[f] == "video") {
            a = H(a)[0];
            k = 1
        }
        if (a[o] != "IMG") {
        ...
        if (!L) {
            L = A("sliderInner");
            g[v](L);
            if (hb() >= 300)g[b].borderRadius = L[b].borderRadius = "0px"
        }
        L[Q] = "";
        var e = i ? i : a.n();
        ...
        if (e < 9)this.q(f, e); else if (e < 13)this.r(f, e); else if (e == 13)this.s(f); else if (e < 16)this.t(f, e); else this.u(f, e)
    }, q: function (c, d) {
        for (var f = 0, g = d < 7 ? {height: 0, opacity: -.4} : {width: 0, opacity: 0}, k = {height: B, opacity: 1}, a = 0, h = c[e]; a < h; a++) {
            if (d < 3)c[a][b].bottom = "0"; else if (d < 5)c[a][b][X] = "0"; else if (d < 7) {
                c[a][b][a % 2 ? "bottom" : "top"] = "0";
                g[i] = -.2
            } else {
                k = {width: c[a][W], opacity: 1};
                c[a][b][j] = c[a][b][X] = "0";
                c[a][b][z] = B + "px"
            }
            mb({}, h, a, c[a], g, k, f);
        ...
        if (c < 11)var e = 0, f = u; else {
            e = 0;
            f = B
        }
        var g = {b: D.a.j, c: a.c * 1.6, a: function () {
            m.o()
        }};
        ...
        for (var q = {c: a.c / 1.3}, k = 0, o = a.g * 2; k < o; k++) {
            for (var h = k, l = 0; l < a.m; l++) {
                if (h >= 0 && h < a.g) {
                    var m = f[l][h];
                    mb(q, c[e], p, m, {width: 0, height: 0, opacity: 0}, {width: m.w, height: m.h, opacity: 1}, n);
                    p++
                }
                h--
            }
        ...
        return(new Function("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", function (c) {
            for (var b = [], a = 0, d = c[e]; a < d; a++)b[b[e]] = String.fromCharCode(c.charCodeAt(a) - 4);
            return b.join("")
        ...
        for (var k = [], i = g > 8 ? u : Math.round(u / a.f), l = g > 8 ? 1 : a.f, f = 0; f < l; f++) {
            ...
            d[b][z] = "0px";
            d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat -' + f * i + "px 0%";
            if (g == 10)d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat right top'; else if (g == 12)d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat left bottom';
            d[b].zIndex = 1;
        ...
        if (a == c.a && eb && !c.c) {
            ...
            if (d[a][f] == "imgLink video") {
                ...
                e = d[a][ab]("video");
                if (!e.length)e = d[a][ab]("audio");
                if (e.length && e[0][b][y] == "none")h = 1
            }
            if (h) {
                K(s);
                s = null;
        ...
        var g = c.a;
        c.a = this.n(a);
        if (i || !l.m)g = 0; else g = g > c.a ? "10" : "9";
        this.p(g)
    }, n: function (a) {
        if (a >= c.d)a = 0; else if (a < 0)a = c.d - 1;
        return a
    }, To: function (a) {
        this.y(this.n(c.a + a))
    }};
    var gb = function () {
        var a = Y(l.sliderId);
        if (a && H(a)[e] && a.offsetHeight)m = new tb(a); else C(gb, 500)
    };
    fb();
    Eb(window, "load", gb);
    var Gb = function () {
    ...
    return{displaySlide: function (c, b, a) {
        m.y(c, b, a)
    }, next: function () {
        m.To(1)
    }, previous: function () {
